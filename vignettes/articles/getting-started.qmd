...
If `formula_y` carries a treatment-by-mediator term (`Y ~ X * M`), the
regmedint engine returns an `InteractionMediationData` with the four-way
decomposition and analytical standard errors. Engine-specific settings go
through `engine_args`; see
